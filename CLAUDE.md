...
- Enum classes are detected by `detect_vocabulary_enum()` and skip trait generation
- `object_property_enum_override()` maps 8 ObjectProperties to enum return types
