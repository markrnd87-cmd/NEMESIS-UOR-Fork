...
/// Instance graph for Test 173: ConstraintNerve -> KanComplex -> PostnikovTruncation -> HomotopyGroup -> HigherMonodromy.
...
resolver:ex_nerve_173 a owl:NamedIndividual, resolver:ConstraintNerve, homology:KanComplex .
