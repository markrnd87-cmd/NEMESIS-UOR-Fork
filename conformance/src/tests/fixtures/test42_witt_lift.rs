/// SHACL test 42: WittLift and IncrementalCompletenessResolver — Amendment 29.
pub const TEST42_WITT_LIFT: &str = r#"
...
type:ex_lift_42 a owl:NamedIndividual, type:WittLift ;
