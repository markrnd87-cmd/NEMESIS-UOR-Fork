...
/// 2. Ontology inventory (counts must equal 16/175/325/637)
...
mod tests_unit {
    ...
    fn spec_inventory_passes() {
        ...
        assert_eq!(ontology.class_count(), 175);
        assert_eq!(ontology.property_count(), 325);
        assert_eq!(ontology.individual_count(), 637);
    }
